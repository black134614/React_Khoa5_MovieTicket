        ...
        <div className="flip-card mt-5">
            <div className="flip-card-inner">
                <div className="flip-card-front">
                    ...
                    <img src={item.hinhAnh} alt="Avatar"  onError={e => {e.target.onerror=null;e.target.src='https://picsum.photos/300/300';}} />
                </div>
            ...
            }} className="bg-orange-300 text-center cursor-pointer py-3 bg-indigo-300 hover:bg-indigo-900 my-2 text-success-50 font-bold">ĐẶT VÉ</div>
        </div>
